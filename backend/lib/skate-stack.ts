...
export class SkateStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props: SkateStackProps) {
    ...
    const zone = route53.HostedZone.fromHostedZoneAttributes(this, 'Zone', {
      hostedZoneId: 'Z0410800359R551QVMSLL', // Replace with actual hosted zone ID
      zoneName: 'johncallstack.me', // Ensure this matches your domain
    });
    ...
    new s3deploy.BucketDeployment(this, 'DeployWebsite', {
      sources: [
        s3deploy.Source.asset(props.staticFilesPath)
      ],
